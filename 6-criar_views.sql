-- 1. listar todos os alunos e suas respectivas disciplinas
...
-- 3. listar os professores e suas disciplinas no período letivo
...
-- 4. listar os alunos com suas respectivas disciplinas e notas
CREATE VIEW vw_alunos_notas AS
SELECT A.Nome AS NomeAluno, A.Sobrenome AS SobrenomeAluno, M.NomeDisciplina, M.Notas
FROM Aluno A
JOIN Matrícula M ON A.Nome = M.NomeAluno AND A.Sobrenome = M.SobrenomeAluno AND A.Telefone = A.Telefone;

-- 5. listar todos os cursos e os respectivos departamentos
...
-- 6. listar os professores e suas especializações
...
-- 7. listar os alunos com matrícula pendente
